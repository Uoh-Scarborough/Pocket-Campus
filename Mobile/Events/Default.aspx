<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Mobile.Events" %>
...
<body onload="hideAddressbar();">
    ...
    <div id="banner">
        ...
        <a href="Default.aspx"><img class="second" src="../Images/EventsHome.png"/></a>
        <h1 class="secondheader">Events</h1>
    </div>

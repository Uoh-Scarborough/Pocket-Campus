<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="StudioBookingMobile.Login" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<body onload="hideAddressbar();">
    ...
    <h1>Login</h1>
        ...
        <form id="studentservices" runat="server">
            ...
            <ul>
                <li>Username: <input id="UserName" type="text" runat="server" style="width:150px;position:relative;top:0px;"/><asp:RequiredFieldValidator ID="RequiredFieldValidator1" 
                        ControlToValidate="UserName" ErrorMessage="Required Field" runat="server" 
                        meta:resourcekey="RequiredFieldValidator1Resource1"/></li>
                <li>Password: <input id="UserPass" type="password" runat="server" style="width:150px;position:relative;top:0px;"/> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" 
                        ControlToValidate="UserPass" ErrorMessage="Required Field" runat="server" 
                        meta:resourcekey="RequiredFieldValidator2Resource1"/></li>

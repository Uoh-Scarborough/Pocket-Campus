    ...
    <div id="content">
        ...
        <asp:MultiView ID="MultiView" runat="server">
            ...
            <asp:View ID="RoomList" runat="server">
                ...
                <ul>
                    <li><a href="?rid=Performance Studio 1"><img class="arrow" src="Images/ArrowButton.jpg"/>Performance Studio 1</a></li>
                    <li><a href="?rid=Performance Studio 2"><img class="arrow" src="Images/ArrowButton.jpg"/>Performance Studio 2</a></li>
                    <li><a href="?rid=Performance Studio 3"><img class="arrow" src="Images/ArrowButton.jpg"/>Performance Studio 3</a></li>
                </ul>

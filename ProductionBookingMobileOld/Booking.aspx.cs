...
namespace ProductionBookingMobile
{
    public partial class Booking : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SBNC = new ClassConnection(ClassAppDetails.configname, ClassAppDetails.pbconnectionname);
            TTNC = new ClassConnection(ClassAppDetails.configname, ClassAppDetails.ttconnectionname);

            ClassAppDetails.pbcurrentconnection = SBNC;
        ...
        protected void Savecmd_Click(object sender, EventArgs e)
        {
            ...
            Booking.AdditionalInfo = AdditionalMemberstxt.Text;

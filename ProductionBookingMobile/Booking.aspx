<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Booking.aspx.cs" Inherits="ProductionBookingMobile.Booking" %>
...
<head id="Head1" runat="server">
    ...
    <title>Production Booking</title>
            ...
            <asp:MultiView ID="MultiView" runat="server">
                <asp:View ID="AddEditView" runat="server">
                    ...
                    <ul>
                        ...
                        <li>Workshop:
                            <asp:CheckBox ID="Workshopchk" runat="server" Style="position: absolute;
                                left: 130px;"/>
                        </li>
                        <li>Additional Group Members:<br />
                            <asp:TextBox ID="AdditionalMemberstxt" runat="server" 
                ...
                <asp:View ID="Deleted" runat="server">
                    ...
                    <ul>
                        <li><a href="Default.aspx">Return to Production Booking</a></li></ul>
                </asp:View>

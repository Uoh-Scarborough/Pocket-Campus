...
namespace ProductionBookingMobile
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private void LoadTimeTable(string RID, int Week, int Day)
        {
            ...
            ArrayList ActivityList = ClassProductionBookings.GenerateDaySet(Day, Week, RID, Context.User.Identity.Name,ClassBooking.BookingType.ProductionBooking);
            ...
            for (int i = 0; i <= 63; i++)
            {
                ...
                if (drawnext == i - 1)
                {
                    ...
                    if (ActivityList.Count > 0 && activitycounter <= ActivityList.Count - 1)
                        ...
                        if (ActivityList[activitycounter].GetType().ToString() == "PocketCampusClasses.ClassProductionBookings")
                        {
                            //Booking
                            ClassProductionBookings Booking = (ClassProductionBookings)ActivityList[activitycounter];

                            //33 - 6 = 27

                            if ((Booking.StartTime - 33) == i)
                            {
                                //Draw This
                            ...
                            {
                                //Draw Blank
                                Cell2.Text = "<a href='Booking.aspx?RID=" + RID + "&amp;WID=" + Week + "&amp;DID=" + Day + "&amp;STID=" + (i + 34) + "'>&nbsp;</a>";
                                drawnext++;
                            }
                        ...
                        else if (ActivityList[activitycounter].GetType().ToString() == "PocketCampusClasses.ClassActivities")
                        {
                            ...
                            {
                                //Draw Blank
                                Cell2.Text = "<a href='Booking.aspx?RID=" + RID + "&amp;WID=" + Week + "&amp;DID=" + Day + "&amp;TID=" + (i + 34) + "'>&nbsp;</a>";
                                drawnext++;
                            }
                        }
                        else

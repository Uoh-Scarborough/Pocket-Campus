<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Groups.aspx.cs" Inherits="ProductionBooking.Groups" MasterPageFile="~/Red.Master" EnableSessionState="True" %>
...
<asp:Content ID="ProductionBookingLogo" ContentPlaceHolderID="HomeButtonCPH" runat="server"><a href="http://productionbooking.scar.hull.ac.uk"><label id="HomeButtonlbl" runat="server"><img src="http://pocketcampusimages.scar.hull.ac.uk/ProductionBookingLogo.png" alt="Production Booking Logo" /></label></a></asp:Content>
            ...
            <table ID="AddGrouptbl">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="GroupNametxt" runat="server" Width="100px"></asp:TextBox> 
                        ...
                        <asp:Button ID="AddGroupbtn"  runat="server" onclick="AddGroupbtn_Click" Text="Add Group" /></td>
                </tr>

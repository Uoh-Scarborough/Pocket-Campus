<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Control_Event.ascx.cs" Inherits="Communications.Controls.Control_Event" %>
...
<asp:MultiView ID="Multiview" runat="server">
    ...
    <asp:View ID="AddEditView" runat="server">
        ...
        <uc1:Control_Base ID="Control_Base" runat="server"  OnBaseValidated="Base_Validated" OnBaseInvalidated="Base_Invalidated" ModuleBaseType="Event" />

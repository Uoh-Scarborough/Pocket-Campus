...
<asp:Content ID="first" ContentPlaceHolderID="MainArea" Runat="Server">
        ...
        <h1>Welcome to Scarborough Campus Communications</h1>

            <p>To enter the Scarborough Campus Communications you must first log into the system using your campus username and password.</p>
